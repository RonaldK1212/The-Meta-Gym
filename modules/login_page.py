...
def draw_decorations():
    ...
    title.place(x = x_size/2,y = 35, anchor = "center")
...
def draw_labels(x_pos, y_pos):
    ...
    user_id_label =  ttk.Label(root, text="ID: ",     font = label_font, background="#292929", foreground = "#ffc815").place(x = x_pos+x_size/2,y = y_pos+6*30, anchor = "e")
    ...
    phone_label =       ttk.Label(root, text="Phone Number: ",    font = label_font, background="#292929", foreground = "#ffc815").place(x = x_pos+x_size/2,y = y_pos, anchor = "e")
    sex_label =         ttk.Label(root, text="Sex: ",            font = label_font, style="SC.TLabel").place(x = x_pos,y = y_pos+4*30, anchor = "e")
    dob_label =         ttk.Label(root, text="Date of Birth: ",  font = label_font, background="#292929", foreground = "#ffc815").place(x = x_pos+x_size/2,y = y_pos+30, anchor = "e")
    weight_label =      ttk.Label(root, text="Weight: ",          font = label_font, background="#292929", foreground = "#ffc815").place(x = x_pos+x_size/2,y = y_pos+2*30, anchor = "e")
    dor_label =         ttk.Label(root, text="Date of \nRegistration: ", font = label_font, style="SC.TLabel").place(x = x_pos, y = y_pos+6*30, anchor = "e")
...
def draw_data(x_pos,y_pos):
    ...
    sex_data.config(text = sex, style="SC.TLabel")
    ...
    dor_data.config(text = dor, style="SC.TLabel")

    user_id_label.place(x = x_pos+x_size/2,y = y_pos+6*30, anchor = "w")
    first_name_data.place(x = x_pos,y = y_pos, anchor = "w")
    last_name_data.place(x = x_pos,y = y_pos+30, anchor = "w")
    phone_data.place(x = x_pos+x_size/2,y = y_pos, anchor = "w")
    sex_data.place(x = x_pos,y = y_pos+4*30, anchor = "w")
    dob_data.place(x = x_pos+x_size/2,y = y_pos+30, anchor = "w")
    weight_data.place(x = x_pos+x_size/2,y = y_pos+2*30, anchor = "w")
    dor_data.place(x = x_pos, y = y_pos+6*30, anchor = "w")
